...
int main()
{
    ...
    if((history = open("./Commands/String/History.txt", O_RDWR, 0644)) == -1)
    {
    ...
    while(strcmp("Cls", args[0]) != 0)
    {
        ...
        else if(pid == 0)
        {
            ...
            if (strcmp(args[0], "PrintFile") == 0 || strcmp(args[0], "Find") == 0)
            {
                for(int i = 1; i < 4; i++)
                {
                    args[i] = strtok(NULL, " ");
            ...
            {
                //special pre-proccessing for the command
                args[1] = strtok(NULL, "\"");
            ...
            else if(strcmp(args[0], "History") == 0)
            {
                ...
                strcat(tempbuff, args[0]);
                // Execute the command with execv
                execl(tempbuff, tempbuff,"./Commands/String/History.txt", NULL);
                exit(1);
            }
            else
            {
